...
class InfermedicaChatScreen extends StatefulWidget {
  const InfermedicaChatScreen({super.key});

  @override
  State<InfermedicaChatScreen> createState() => _InfermedicaChatScreenState();
}

class _InfermedicaChatScreenState extends State<InfermedicaChatScreen> {
